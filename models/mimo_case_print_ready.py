...
from mimo_case_print_ready_geometry import PrintReadyParams, front_anchor, front_back_halves_raw, validate_print_ready_alignment, viewer_aligned
...
def gen_step():
    ...
    shape = viewer_aligned(Compound([back_half, front_half]))
    shape.label = "mimo-case-print-ready"
    return {
        "shape": shape,
        "step_output": "mimo_case_print_ready.step",
    }
