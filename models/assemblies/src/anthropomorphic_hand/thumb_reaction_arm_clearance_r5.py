...
@step(out='../../STEP/anthropomorphic_hand/thumb_reaction_arm_clearance_r5.step')
def thumb_reaction_arm_clearance_r5():
    ...
    (ROOT/'validation/anthropomorphic_hand/thumb_reaction_arm_clearance_r5_build.json').write_text(json.dumps(report,indent=2)+'\n')
