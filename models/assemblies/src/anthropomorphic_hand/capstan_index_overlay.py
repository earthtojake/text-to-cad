...
FRAMES = HERE.parents[1] / 'validation/anthropomorphic_hand/mechanical_candidate_r13_frames.json'
...
@step(out='../../STEP/anthropomorphic_hand/capstan_index_overlay.step')
