...
@step(out='../../STEP/anthropomorphic_hand/thumb_reaction_arm_clearance_r2.step')
def thumb_reaction_arm_clearance_r2():
    ...
    (ROOT/'validation/anthropomorphic_hand/thumb_reaction_arm_clearance_r2_build.json').write_text(json.dumps(report,indent=2)+'\n')
