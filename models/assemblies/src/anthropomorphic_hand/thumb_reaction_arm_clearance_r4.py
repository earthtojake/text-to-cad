...
@step(out='../../STEP/anthropomorphic_hand/thumb_reaction_arm_clearance_r4.step')
def thumb_reaction_arm_clearance_r4():
    ...
    (ROOT/'validation/anthropomorphic_hand/thumb_reaction_arm_clearance_r4_build.json').write_text(json.dumps(report,indent=2)+'\n')
