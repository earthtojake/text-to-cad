...
_candidate_atlas=json.loads(Path('models/assemblies/validation/anthropomorphic_hand/thumb_cmc_outlet16_axes.json').read_text())+json.loads(Path('models/assemblies/validation/anthropomorphic_hand/thumb_cmc_outlet16_topflex.json').read_text())
