...
| Burr         | Browses STEP, STL, and GLB projects and checks geometric interference between components in STEP assemblies.                                         | [skills/burr](skills/burr/SKILL.md)                 |
| KiCad        | Creates and validates KiCad electronics projects, then exports populated boards for mechanical handoff when needed.                                  | [skills/kicad](skills/kicad/SKILL.md)               |
