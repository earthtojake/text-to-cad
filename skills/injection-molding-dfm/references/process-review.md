...
If a side wall has measured 0.5 degree draft relative to the confirmed pull and the selected texture/tooling specification requires 2 degrees, report the shortfall for that wall. Without a confirmed pull direction, report draft as unverified rather than failing every vertical-looking face.
