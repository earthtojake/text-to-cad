...
import { loadRenderSurfPayloadAtLevel } from "@hardcore/core/lib/renderAssetClient.js";
import { LOD_CHORD_LEVELS } from "@hardcore/core/lib/surf/lodPolicy.js";
...
export function useViewportLod({ viewerRef, lodPackage, applyComponentLodPayload, tessellationCache }) {
