...
/** @param {unknown} origin @param {unknown} path @returns {string} */
...
// three unchanged.
/** @param {import('./types.js').CadEntry} entry @param {unknown} origin @returns {import('./types.js').CadEntry} */
...
/** @param {import('./types.js').CadEntry[] | null | undefined} entries @param {unknown} origin @returns {import('./types.js').CadEntry[]} */
