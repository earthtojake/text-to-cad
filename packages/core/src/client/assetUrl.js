...
import { isAbsoluteViewerUrl } from "./origin.js";
...
/** @param {unknown} baseDir @param {unknown} relPath @returns {string} */
...
/** @param {unknown} packageAssetUrl @param {unknown} relPath @returns {string} */
