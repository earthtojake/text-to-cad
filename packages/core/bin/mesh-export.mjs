...
import { parseSurf } from "../dist/lib/surf/container.js";
import { DEFAULT_OPTIONS, tessellateComponent } from "../dist/lib/surf/tessellate.js";
import {
  decodeComponentTessellation,
  edgeClassesFromSurfIndex,
  encodeComponentTessellation,
  tessellationCacheKey,
} from "../dist/lib/surf/tessellationCache.js";
import {
  readCachedTessellationBytes,
  writeCachedTessellationBytes,
} from "../dist/lib/surf/tessellationCacheFs.mjs";
import {
  PACKAGE_MESH_EXPORT_FORMATS,
  buildPackageMeshPrimitives,
  packageMeshToFormat,
} from "../dist/lib/export/packageMeshExport.js";
import {
  restrictAnimationToNodes,
  sampleClipAnimation,
  withMorphChannels,
} from "../dist/lib/export/packageAnimation.js";
