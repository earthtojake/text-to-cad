...
test("stepToward names the entry of a directory that lies on the way to a path", () => {
  assert.equal(stepToward("", "apps/viewer/main.jsx"), "apps");
  assert.equal(stepToward("apps", "apps/viewer/main.jsx"), "apps/viewer");
  assert.equal(stepToward("apps/viewer", "apps/viewer/main.jsx"), "apps/viewer/main.jsx");
  // Not on the way at all: a sibling folder, or a prefix that is not a segment.
  assert.equal(stepToward("packages", "apps/viewer/main.jsx"), null);
  assert.equal(stepToward("app", "apps/viewer/main.jsx"), null);
