...
| `sample/` | committed | the sample project onboarding offers: `l_bracket.py` and the `l_bracket.step` it builds. Main copies it to `~/Documents/Hardcore Sample` the first time someone asks for it (`src/main/onboarding.ts`). |
